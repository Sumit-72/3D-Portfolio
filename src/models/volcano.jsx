...
const Island = ({isRotating, setIsRotating, setCurrentStage,targetRotation, ...props}) => {
  ...
  useFrame(()=>{
    // if (islandRef.current.rotation.z !== targetRotation) {
    //   const delta = (targetRotation - islandRef.current.rotation.z) * 0.1; // Smooth transition
    //   islandRef.current.rotation.z += delta;
    // }
    // fix it later
    if(!isRotating){
    ...
    //     setCurrentStage(null);
      case normalizedRotation <= 2.2 && normalizedRotation >=0.2:
      setCurrentStage(1);
      break;
      case normalizedRotation > 2.2 && normalizedRotation < 3:
        setCurrentStage(4); // start at stage 0, diff stages for diff prompts
        break;
      case normalizedRotation >= 3.5 && normalizedRotation < 6:
        setCurrentStage(3);
        break;
      case normalizedRotation >= 5.99 || (normalizedRotation < 3):
        setCurrentStage(2);
        break;
      default:
        setCurrentStage(null);
